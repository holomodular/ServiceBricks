...
namespace ServiceBricks.Xunit
{
    ...
    public partial class ApiControllerTests
    {
        ...
        public class ExampleController : ApiController<ExampleDto>
        {
            public ExampleController(
                IApiService<ExampleDto> domainObjectService,
                IOptions<ApiOptions> apiOptions) : base(domainObjectService, apiOptions)
            {
            }
        }

        public class ExampleAdminController : AdminPolicyApiController<ExampleDto>
        {
            public ExampleAdminController(
                IApiService<ExampleDto> domainObjectService,
                IOptions<ApiOptions> apiOptions) : base(domainObjectService, apiOptions)
            {
            }
        ...
        public class ExampleUserController : UserPolicyApiController<ExampleDto>
        {
            public ExampleUserController(
                IApiService<ExampleDto> domainObjectService,
                IOptions<ApiOptions> apiOptions) : base(domainObjectService, apiOptions)
            {
            }
        ...
        [Fact]
        public virtual Task ApiControllerCallStorageSuccess()
        {
        ...
        [Fact]
        public virtual async Task ApiControllerCallStorageSuccessAsync()
        {
            var businessRuleService = SystemManager.ServiceProvider.GetRequiredService<IBusinessRuleService>();
            ...
            await controller.GetAsync(dto.StorageKey);
            Assert.True(storageRepository.GetAsyncCalled);
            ...
            await controller.DeleteAsync(dto.StorageKey);
            Assert.True(storageRepository.DeleteAsyncCalled);
            Assert.True(storageRepository.GetAsyncCalled);
            storageRepository.GetAsyncCalled = false;
        ...
        [Fact]
        public virtual Task UserApiControllerCallStorageSuccess()
        {
            var businessRuleService = SystemManager.ServiceProvider.GetRequiredService<IBusinessRuleService>();
            ...
            var apiservice = new ExampleApiService(
                ...
                domainRepo);
            var options = new OptionsWrapper<ApiOptions>(new ApiOptions() { });
            var controller = new ExampleUserController(
                apiservice,
                options);
            var dto = new ExampleDto() { StorageKey = "1" };
        ...
        [Fact]
        public virtual async Task UserApiControllerCallStorageSuccessAsync()
        {
            var businessRuleService = SystemManager.ServiceProvider.GetRequiredService<IBusinessRuleService>();
        ...
        [Fact]
        public virtual Task AdminApiControllerCallStorageSuccess()
        {
            var businessRuleService = SystemManager.ServiceProvider.GetRequiredService<IBusinessRuleService>();
            ...
            var apiservice = new ExampleApiService(
                ...
                domainRepo);
            var options = new OptionsWrapper<ApiOptions>(new ApiOptions() { });
            var controller = new ExampleAdminController(
                apiservice,
                options);
            var dto = new ExampleDto() { StorageKey = "1" };
        ...
        [Fact]
        public virtual async Task AdminApiControllerCallStorageSuccessAsync()
        {
            var businessRuleService = SystemManager.ServiceProvider.GetRequiredService<IBusinessRuleService>();
