...
namespace ServiceBricks.Storage.SqlServer
{
    /// <summary>
    /// This rule migrates a database.
    /// </summary>
    public sealed class SqlServerDatabaseMigrationRule<TModule, TDatabaseContext> : BusinessRule
        ...
        where TDatabaseContext : DbContext
    {
        ...
        /// Constructor.
        /// </summary>
        public SqlServerDatabaseMigrationRule()
        {
        ...
        public static void Register(IBusinessRuleRegistry registry)
        {
            registry.Register(
                ...
                typeof(SqlServerDatabaseMigrationRule<TModule, TDatabaseContext>));
        }
